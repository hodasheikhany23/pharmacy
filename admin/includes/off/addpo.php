...
<div class="form-container">
    <form method="post" action="">
        ...
        <div class="mb-3">
            ...
            echo '</select>';
            echo '<label for="category" class="form-label">محصول    </label>  
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // اگر نام‌های انتخاب شده در هردو یکسان است، بهتر است به صورت جداگانه نام بدهی
        const drugSelectElement = document.querySelector('select[name="drug"]'); // فرض کن نام سلکت دارو "drug"
        ...
        categorySelect.addEventListener('change', function() {
            ...
            // اگر اوپن شدن مجدد می‌خواهی، می‌تواند اول گزینه‌ی پیش‌فرض خودت را انتخاب کنی
