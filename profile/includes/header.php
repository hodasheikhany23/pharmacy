...
<div class="sidebar active d-flex flex-column" id="sidebar" style="width: 16rem !important;"> <!-- added active class for default open -->
    ...
    <a class="sidebar-item menu-sub-parent" onclick="sub()" href="index.php?page=pages">
        <i class="fa-solid fa-file"></i>
        صفحات
    </a>
    <a class="sidebar-item" href="index.php?page=products">
    <i class="fa-solid fa-bottle-droplet"></i>
        دارو ها
    </a>
    <a class="sidebar-item" href="index.php?page=blogs">
        <i class="fa-solid fa-bookmark"></i>
        مقالات
    </a>
    <a class="sidebar-item" href="index.php?page=categories">
